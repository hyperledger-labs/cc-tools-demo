...
docker-compose -f docker-compose-hlf2-org1.yaml -p ccapi.org1.example.com up -d
docker-compose -f docker-compose-hlf2-org2.yaml -p ccapi.org2.example.com up -d
docker-compose -f docker-compose-hlf2-org3.yaml -p ccapi.org3.example.com up -d
