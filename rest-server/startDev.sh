...
docker-compose -f docker-compose-hlf1-org1.yaml -p mainchannel.org1.example.com up -d
docker-compose -f docker-compose-hlf1-org2.yaml -p mainchannel.org2.example.com up -d
docker-compose -f docker-compose-hlf1-org3.yaml -p mainchannel.org3.example.com up -d
